...
const Footer = () => {
  return (
    <footer
      className="bg-white p-6 text-black md:text-xl md:px-12 lg:px-36 xl:px-48"
      id="kontakt"
    >
      ...
      <div className="mt-6 flex flex-col justify-between gap-2">
        ...
        <div className="mt-4 flex gap-8 md:gap-12">
          <a href="https://www.facebook.com/skni.kod/" aria-label="Facebook">
            <svg
              className="h-12 w-12 rounded-lg bg-blue-500 p-2 text-white md:h-16 md:w-16 hover:scale-110 transition-all"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="2"
          ...
          <a href="https://www.youtube.com/channel/UCp5gdqU6815vVn-G_BCKjDQ/featured" aria-label="YouTube">
            <svg
              className="h-12 w-12 rounded-lg bg-blue-500 p-2 text-white md:h-16 md:w-16 hover:scale-110 transition-all"
              viewBox="0 0 24 24"
              fill="none"
        ...
        <div className="mx-auto mt-6 w-fit lg:mr-0">
